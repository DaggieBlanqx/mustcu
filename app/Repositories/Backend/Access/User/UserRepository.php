...
class UserRepository extends BaseRepository
{
	...
	public function updateUserStation($station)
	{
		$user = $this->find($station->manager_id);
    ...
    protected function createUserStub($input)
    {
        ...
        $user->station_id = ($input['user_type'] == config('access.user_types.station_employee')) ? $input['station_id'] : null;
